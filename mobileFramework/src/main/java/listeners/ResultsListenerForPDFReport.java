 ...
 */
public class ResultsListenerForPDFReport implements ITestListener {
	/**
	 * Document
	 */
	 ...
	 * JyperionListener
	 */
	public ResultsListenerForPDFReport() {
	...
	public void onTestSuccess(ITestResult result) {
		...
		ScriptLogger.debug(result.getMethod().toString());
		this.successTable.addCell(cell);
	...
	public void onStart(ITestContext context) {
		log("onStart("+context+")");
		try {
			String filename = new File("").getAbsoluteFile().toString() +"/target/"+ context.getName()+ "-" +System.currentTimeMillis()+".pdf";
