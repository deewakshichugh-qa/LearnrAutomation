...
public class TestPass_OR {
	...
	@AndroidFindBy(xpath = "//android.widget.ImageView[contains(@content-desc,\"btn_back\")]")
	...
	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc,\"Explore\")]")
	...
	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc,\"All Exams, One Subscription\")]")
...
//	}
	...
	@AndroidFindBy(xpath = "//*[@content-desc=\"What will you get\"]")
	...
	@AndroidFindBy(xpath = "//android.view.View[contains(@content-desc,\"goal_selection_arrow\")]/android.widget.ImageView")
	private List<MobileElement> whatWillYouGetBelowArrowOnPDP;

	public List<MobileElement> whatWillYouGetBelowArrowOnPDP() {
    ...
    @AndroidFindBy(xpath = "//android.view.View[@content-desc=\"Our Plans\"]")
    private MobileElement ourPlans;

    public MobileElement ourPlans() {
        return ourPlans;
    }

    @AndroidFindBy(xpath = "//android.widget.FrameLayout[@resource-id=\"android:id/content\"]/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.view.View[2]")
    private MobileElement ourPlansDropDown;

    public MobileElement ourPlansDropDown() {
        return ourPlansDropDown;
    }

    @AndroidFindBy(xpath = "//*[contains(@content-desc,\"off\")]")
    private MobileElement percentOff;

    public MobileElement percentOff() {
        return percentOff;
    }

    @AndroidFindBy(xpath = "//android.widget.Button[@content-desc=\"BUY NOW\"]")
    private MobileElement buyNowOnOurPlan;

    public MobileElement buyNowOnOurPlan() {
        return buyNowOnOurPlan;
    }

    @AndroidFindBy(xpath = "//*[contains(@content-desc,\"months\")]")
    private MobileElement monthsIcon;

    public MobileElement monthsIcon() {
        return monthsIcon;
    }

    @AndroidFindBy(xpath = "//*[contains(@content-desc,\"shareButtonClick\")]")
    private MobileElement shareButtonOnPDP;

    public MobileElement shareButtonOnPDP() {
        return shareButtonOnPDP;}

    @AndroidFindBy(xpath = "//*[contains(@content-desc,\"Scrim\")]")
    private MobileElement shareButtonScreen;

    public MobileElement shareButtonScreen() {
        return shareButtonScreen;}
}
