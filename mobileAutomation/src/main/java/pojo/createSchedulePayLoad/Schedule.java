...
package pojo.createSchedulePayLoad;
...
@JsonPropertyOrder({ "olcFacultyId", "startDate", "startTime", "endTime", "topic", "classRoom", "attachement",
		"cancelled", "cancelReason", "rescheduled", "rescheduleReason", "active", "currentState", "description",
		"isOneTwoOneEnable" })
