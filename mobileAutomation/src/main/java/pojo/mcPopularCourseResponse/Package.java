...
public class Package {
    ...
    @JsonProperty("linkedPkgs")
    private String linkedPkgs;
    @JsonProperty("iosPrice")
    private Integer iosPrice;
    @JsonProperty("defaultCoupons")
    private DefaultCoupons defaultCoupons;
    @JsonIgnore
    ...
    @JsonProperty("linkedPkgs")
    public String getLinkedPkgs() {
        return linkedPkgs;
    }

    @JsonProperty("linkedPkgs")
    public void setLinkedPkgs(String linkedPkgs) {
        this.linkedPkgs = linkedPkgs;
    }
    ...
    @JsonProperty("defaultCoupons")
    public DefaultCoupons getDefaultCoupons() {
        return defaultCoupons;
    }

    @JsonProperty("defaultCoupons")
    public void setDefaultCoupons(DefaultCoupons defaultCoupons) {
        this.defaultCoupons = defaultCoupons;
    }
