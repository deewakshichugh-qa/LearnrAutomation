...
public class DeeplinkWithLoginTest extends BaseTestWithLoginDeeplink {

    @Test(dataProvider = "getData")
    public void verifyDeepLinkWithLogin(DeepLinkData deepLinkData) {
        boolean result = true;
        ...
        result = deepLinkObj.verifyDeeplink(getDriver(), deepLinkData, true);
