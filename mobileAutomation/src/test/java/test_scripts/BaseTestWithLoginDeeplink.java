...
public class BaseTestWithLoginDeeplink {
    ...
    @Parameters({"deviceName", "port", "udid"})
    @BeforeSuite
    public void startSuite(ITestContext context, @Optional("") String deviceName, @Optional("4723") String port, @Optional("") String udid) {
        try {
            ...
            System.out.println("--------------------------------------------------------");
            System.out.println("Executing Test: DeeplinkWithLoginTest" + " | Port: " + port + " | UDID: " + udid);

            // Initialize the driver for the first time
            ...
            if (isInstalled) {
                ...
                if (result) {
                    ...
                    throw new RuntimeException("Truecaller installed but not visible");
                }
            }
            ...
            // Handle permission prompt again
            ...
            System.out.println("startSuite finished.");
        }
    }
    ...
    public void setUp(Method method) {
        ...
        try {
            ...
            System.out.println("Method Name: " + strTestCaseName);

            // Set up cloud or local configurations
            if (ConfigFileReader.strRunMode.equalsIgnoreCase("cloud")) {
                getDriver().executeScript("lambda-name = " + strTestCaseName);
